	...
	<head>
		...
		<script>
			$(document).on('click','.editar', (e)=>{
				...
				//Criando formulario
				var form = $('<form></form>').addClass('row').attr({'id': 'form', 'action': 'tarefa_controller.php?pag=index&acao=atualizar', 'method': 'post'});
			...
			$(document).on('click', '.marcar-feita', (e)=>{
				location.href = 'index.php?pag=index&acao=marcar-feita&id='+$(e.target).attr('data-id-tarefa');
			})
			$(document).on('click', '.excluir', (e)=>{
				location.href = 'index.php?pag=index&acao=remover&id='+$(e.target).attr('data-id-tarefa');
			})
		</script>
	</head>
